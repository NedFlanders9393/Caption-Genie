    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Section title="Who We Are">
          OneSpark ("we," "us," or "our") is an AI-powered social media caption generator for small business owners and content creators. This Privacy Policy explains how we collect, use, and protect your information when you use our app.
        </Section>
        ...
        <Section title="How We Use Your Information">
          ...
          {"\n\n"}• Provide and personalize the OneSpark service{"\n"}
        ...
        <Section title="Third-Party Services">
          We work with trusted third parties to deliver OneSpark:
          {"\n\n"}
        ...
        <Section title="Children's Privacy">
          OneSpark is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe a child has provided us information, please contact us and we will delete it promptly.
        </Section>
