    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <Section title="Agreement to Terms">
          By downloading, installing, or using Captura, you agree to be bound by these Terms of Service. If you do not agree, please do not use the app.
        </Section>

        <Section title="Description of Service">
          Captura is an AI-powered caption generation tool for social media. We provide free and Pro subscription tiers. The free tier includes up to 10 caption generations per month. The Pro tier provides up to 500 generations per month and is billed through Apple's In-App Purchase system.
        </Section>
        ...
        <Section title="Acceptable Use">
          ...
          {"• Resell or redistribute access to Captura without our written permission\n"}
          {"• Use the service to generate spam or misleading content at scale"}
        </Section>

        <Section title="AI-Generated Content">
          Captura uses Claude AI (Anthropic) to generate captions. You acknowledge that:{"\n\n"}
        ...
        <Section title="Intellectual Property">
          The Captura app, its design, logo, and underlying technology are owned by us and protected by intellectual property laws. You are granted a limited, non-exclusive, non-transferable license to use the app for personal or business purposes in accordance with these Terms.
        </Section>
        ...
        <Section title="Disclaimer of Warranties">
          Captura is provided "as is" without warranties of any kind. We do not warrant that the service will be uninterrupted, error-free, or that AI-generated content will meet your specific requirements.
        </Section>

        <Section title="Limitation of Liability">
          To the fullest extent permitted by law, Captura and its owners shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the app, including but not limited to loss of revenue or data.
        </Section>
