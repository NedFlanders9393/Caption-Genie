...
const STREAK_MESSAGES = [
  { title: "Keep your streak alive 🔥", body: "Open Captura and write a caption to keep your momentum going." },
  ...
  { title: "Small habits, big results 💡", body: "One caption a day keeps the blank page away. Open Captura." },
];
