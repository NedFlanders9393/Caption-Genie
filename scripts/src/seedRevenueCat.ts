...
const MONTHLY_PRODUCT_ID = "com.captionai.app.pro";
const MONTHLY_PLAY_STORE_ID = "com.captionai.app.pro:monthly";
const MONTHLY_DISPLAY_NAME = "Captly Pro Monthly";
const MONTHLY_TITLE = "Captly Pro Monthly";
...
const CREDIT_PACKS = [
  {
    ...
    title: "20 Captly Credits",
    packageId: "credits_50",
    packageName: "20 Credits – $3.99",
    prices: [
      { amount_micros: 3990000, currency: "USD" },
      { amount_micros: 3990000, currency: "EUR" },
    ],
  },
  {
    label: "Credits200",
